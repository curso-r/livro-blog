...
Neste texto vamos discutir um pouco sobre regressão logística, tensorflow e Modelos Lineares Generalizados (*Generalized Linear Models*, GLMs). Não vou economizar nas matemáticas nem nos códigos.
