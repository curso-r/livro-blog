...
2) Quem manjava Machine Learning antes vai conseguir aplicar 95% do seu conhecimento nas aplicações de Deep Learning (incluindo bayesianismo, bootstrap, inferência, probabilidade e a boiada toda).
...
knitr::include_graphics("assets/imgs/segundo-menor-dl/y1.png")
```

**Resposta `y_2`**

```{r, fig.height=3, echo=FALSE}
knitr::include_graphics("assets/imgs/segundo-menor-dl/y2.png")
```
...
knitr::include_graphics("assets/imgs/segundo-menor-dl/dl_inf.png")
```
