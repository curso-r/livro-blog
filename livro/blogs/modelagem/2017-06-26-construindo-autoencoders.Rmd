...
```{r, echo=FALSE}
encoded_imgs <- readRDS("assets/data/construindo-autoencoders/autoencoder-encoded_imgs.rds")
dim(encoded_imgs)
encoded_imgs[1,]
```
...
```{r echo=FALSE}
plot(readRDS("assets/data/construindo-autoencoders/autoencoder-plot1.rds"))
```
...
```{r, echo = FALSE}
plot(readRDS("assets/data/construindo-autoencoders/autoencoder-plot2.rds"))
```
