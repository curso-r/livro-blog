...
library(magick)
x <- image_read('../../assets/imgs/as-paletas-de-cores-da-marvel-vs-dc/bvs.jpg')
plot(x)
```

```{r, echo=FALSE, fig.width=8, fig.height=5, eval = TRUE}
x <- image_read('../../assets/imgs/as-paletas-de-cores-da-marvel-vs-dc/cw.jpg')
plot(x)
```
...
x <- image_read('../../assets/imgs/as-paletas-de-cores-da-marvel-vs-dc/paleta_bvs.jpeg')
plot(x)
```
...
```{r, echo=FALSE, fig.width=8, fig.height=4, eval = TRUE}
x <- image_read('../../assets/imgs/as-paletas-de-cores-da-marvel-vs-dc/paleta_cw.jpeg')
plot(x)
```
...
```{r, echo=FALSE, fig.width=8, fig.height=5, eval = TRUE}
x <- image_read('../../assets/imgs/as-paletas-de-cores-da-marvel-vs-dc/posteres.jpg')
plot(x)
```
...
```{r, echo=FALSE, fig.width=8, fig.height=4, eval = TRUE}
x <- image_read('../../assets/imgs/as-paletas-de-cores-da-marvel-vs-dc/paleta_poster_bvs.jpeg')
plot(x)
```
...
```{r, echo=FALSE, fig.width=8, fig.height=4, eval = TRUE}
x <- image_read('../../assets/imgs/as-paletas-de-cores-da-marvel-vs-dc/paleta_poster_cw.jpeg')
plot(x)
```
